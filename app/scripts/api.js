...
shopbackApp.service('ApiService', function () {
    this.api = {
        ...
        'order':{
            'listWithCondition': 'http://localhost:8888/api/orders/seller/list',
        ...
        'postage' : {
            'list' : 'http://localhost:8888/api/logistic/postage/list/detail',
            'save' : 'http://localhost:8888/api/logistic/postage/',
            'refresh' : 'http://localhost:8888/api/logistic/postage/:ID',
            'remove' : 'http://localhost:8888/api/logistic/postage/:ID',
            'single' : 'http://localhost:8888/api/logistic/postage/:ID'
        },
        'area' : {
            'province' : {
                'list' : 'http://localhost:8888/api/statics/area/province/list',
                'listWithCity' : 'http://localhost:8888/api/statics/area/province/city/list'
            },
            'city' : {
                'list' : 'http://localhost:8888/api/statics/area/city/list/:provinceID'
            }
        },
        ...
        'goodstype':{
            'typelist':'http://localhost:8888/api/goods/type/list/',
            'save':'http://localhost:8888/api/goods/type/save',
            'getbyid':'http://localhost:8888/api/goods/type/single/:tid',
            'update':'http://localhost:8888/api/goods/type/update/:tid',
            'del':'http://localhost:8888/api/goods/type/del/:tid',
            'byname':'http://localhost:8888/api/goods/type/singleByName/:tname'
        },
        'marketing':{
            'auction':{
                'goods':{
                    'save' : 'http://localhost:8888/api/marketing/auction/goods/addition',
                    'list':'http://localhost:8888/api/marketing/auction/goods/list',
                    'count':'http://localhost:8888/api/marketing/auction/goods/count',
                    'single':'http://localhost:8888/api/marketing/auction/goods/detail',
                    'refresh':'http://localhost:8888/api/marketing/auction/goods'
                }
            },
            'group':{
            ...
            'groupGoods':{
                'save':'http://localhost:8888/api/marketing/group/goods/addition',
                'list':'http://localhost:8888/api/marketing/group/goods/list',
                'count':'http://localhost:8888/api/marketing/group/goods/count',
                'single':'http://localhost:8888/api/marketing/group/goods/detail',
                'refresh':'http://localhost:8888/api/marketing/group/goods'
            },
            'flashsale':{
                'save':'http://localhost:8888/api/flash/sale/add',
                'list':'http://localhost:8888/api/flash/sale/list',
                'single':'http://localhost:8888/api/flash/sale/detail',
                'refresh':'http://localhost:8888/api/flash/sale/update'
            }
        },
        'logistic':{
         ...
         'wapgoods':{
            'skulist':'http://localhost:8888/api/wap/goods/skus/:gid',
            'allList':'http://localhost:8888/api/wap/goods/list',
            'thisMerchant':'http://localhost:8888/api/merchant/merchantBySellerId/:sellerId',
            'types':'http://localhost:8888/api/goods/type/list',
            'save':'http://localhost:8888/api/goods/operation/save',
            'del':'http://localhost:8888/api/goods/operation/del/:gid',
            'view':'http://localhost:8888/api/goods/operation/view/:gid'
        }
    }
});
